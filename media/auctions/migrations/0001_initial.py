# Generated by Django 5.0 on 2024-08-06 12:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Fashion', 'Fashion'), ('Toys', 'Toys'), ('Electronics', 'Electronics'), ('Home', 'Home')], default='Fashion', max_length=64)),
                ('description', models.CharField(max_length=64)),
                ('image', models.ImageField(default='media/default.jpg', upload_to='media/')),
                ('starting_bid', models.FloatField()),
                ('active', models.BooleanField(default=False)),
                ('start_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('end_time', models.DateTimeField(default=auctions.models.default_end_time)),
